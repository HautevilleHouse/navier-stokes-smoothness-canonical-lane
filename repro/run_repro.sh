...
mkdir -p .codex_tmp/ns_closure
cp artifacts/stitch_constants.json .codex_tmp/ns_closure/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/ns_closure/constants_registry.json

python3 scripts/ns_closure_guard.py \
  --strict-coh-zero \
  --registry artifacts/constants_registry.json \
  --stitch artifacts/stitch_constants.json \
